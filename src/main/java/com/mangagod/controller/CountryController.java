...
public class CountryController {
	...
	public ResponseEntity<MainResponse> getCountryById(@PathVariable (name = "country_id") int countryId){
		CountryDataDTO countryDataDTO = this.countryService.getById(countryId);
		MainResponse mainResponse = new MainResponse(true, "Obteniendo pais por ID.", countryDataDTO);
		return new ResponseEntity<MainResponse>(mainResponse, HttpStatus.OK);
	}
	...
	public ResponseEntity<MainResponse> deleteCountry(@PathVariable (name = "country_id") int countryId){
		CountryDataDTO countryDataDTO = this.countryService.delete(countryId);
		MainResponse mainResponse = new MainResponse(true, "El pais ha sido eliminado exitosamente!", countryDataDTO);
		return new ResponseEntity<MainResponse>(mainResponse, HttpStatus.OK);
	}
