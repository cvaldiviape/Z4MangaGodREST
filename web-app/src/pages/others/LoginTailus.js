  ...
  return (
    <div className="2xl:container h-screen m-auto">
      <div hidden className="fixed inset-0 w-7/12 lg:block">
        ...
        <video className="w-full h-full object-cover" loop autoplay src="images/video.mp4" poster="../public/images/bg.jpg"></video>
      </div>
      ...
      <div className="relative h-full ml-auto lg:w-6/12">
        <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
          <div className="space-y-4">
            <a href="">
              <img src="images/tailus.svg" className="w-40" alt="tailus logo" />
            </a>
            <p className="font-medium text-lg text-gray-600">Welcome to tailus ! Login first</p>
          </div>
